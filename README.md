...
- Ads (Adsterra, Adsense)


# Install Guide

Warning: You need Pterodactyl already setup on a domain for PT-RS Client to work
...
10. Run `nano /etc/nginx/sites-enabled/ptrsclient.conf`
...
# License
Released under [GNU AFFERO GENERAL PUBLIC LICENSE](LICENSE)
